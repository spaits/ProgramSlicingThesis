...
def linenoise():
    ...
    compare_to_ideal(PROJECT, 'Clang', clang, ideal)
...
def stb():
    ...
    clang = [92 , 97 , 98 , 103, 105, 119, 120, 252, 253, 254, 255, 256, 257, 258, 259, 260, 262, 263, 264, 265, 266, 267, 271, 272, 273, 275, 276, 277, 278, 280, 281, 282, 283, 285, 286, 287, 288, 289, 290, 291, 292, 294]
    compare_to_ideal(PROJECT, 'Unravel', unravel, ideal)
    compare_to_ideal(PROJECT, 'LLVM-Slicer', llvm_slicer, ideal)
    compare_to_ideal(PROJECT, 'Frama-C', frama_c, ideal)
    compare_to_ideal(PROJECT, 'Clang', clang, ideal)
...
def tiny_json():
    ...
    ideal = [452, 453, 456 458, 459, 460, 462, 463, 464, 466, 467, 469, 468 473, 474, 476, 478, 479, 480, 481, 486, 487, 488, 492, 494, 495, 499, 501, 502, 503, 504, 505, 507, 538, 537, 536, 535, 546, 547, 548, 550, 560]
    ...
    clang = [431, 432, 433, 434, 452, 453, 455, 456, 458, 459, 460, 461, 462, 463, 464, 466, 467, 468, 469, 470, 471, 473, 476, 477, 478, 483, 484, 485, 486, 487, 488, 489, 490, 491, 492, 493, 494, 495, 496, 497, 498, 499, 500, 507, 535, 536, 537, 546, 547, 548, 560]
